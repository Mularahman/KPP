...
@section('breadcumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data WIFI</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Data WIFI</h6>
    </nav>
@endsection
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <div class="d-flex ">
                                        ...
                                        <div class="my-auto">
                                          <h6 class="mb-0 text-xs">{{$item->ip_wifi}}</h6>
                                        </div>
                                      </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                      <p class="text-xs font-weight-bold mb-0">{{$item->mode}}</p>
                                    </td>
                                    <td>
                                      <p class="text-xs font-weight-bold mb-0">{{$item->merk}}</p>
                                    </td>
                                    <td>
                                      <p class="text-xs font-weight-bold mb-0">{{$item->series}}</p>
                                    </td>
                                    <td>
