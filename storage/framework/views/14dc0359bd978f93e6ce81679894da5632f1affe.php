        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <a class="btn bg-gradient-success d-inline-flex me-md-2 " href="/enrolle/<?php echo e($id); ?>/cetak">
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <div class="modal fade" id="exampleModal2<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <?php echo $__env->make('admin.datapesertaquiz.hapus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
