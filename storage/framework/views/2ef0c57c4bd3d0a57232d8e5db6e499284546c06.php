                ...
                <div class="card-body px-2 py-2 pt-0 pb-2">
                    <div class="table-responsive p-2">
                        <table class="table align-items-center mb-0">
                            <form action="/tambahsoal/<?php echo e($id); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select class="form-control" id="jawaban" name="jawaban">
                                                <option <?php echo e(old('jawaban') ? '' : 'selected disabled'); ?>>Pilihan Jawaban</option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tes Psikotes\resources\views/admin/datasoal/tambahsoal.blade.php ENDPATH**/ ?>