...
<section class="py-7" id="mulai">
    ...
    <div class="row">
                <?php $__currentLoopData = $quizuser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($item->status == 0): ?>
                <a href="/<?php echo e($item->quiz->slug); ?>" class="col-md-6 col-lg-4 mt-4 pb-3 mt-lg-0 mt-md-0 mb-3 move-on-hover">
                    <div class="card bg-gradient-success d-flex flex-column h-100 pt-3 text-center shadow-soft text-white rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <h3 class=" fw-bold mb-4 text-light">
                                ...
                                <?php echo e($item->quiz->quiz); ?>

                            </h3>
                            <p class="text-dark"><?php echo e($item->quiz->deskripsi); ?></p>
                            <div class="mt-auto">
                ...
                <?php else: ?>
                <a href="/hasil/<?php echo e($item->quiz->token); ?>" class="col-md-6 col-lg-4 mt-4 pb-3 mt-lg-0 mt-md-0 mb-3 move-on-hover">
                    <div class="card bg-gradient-success d-flex flex-column h-100 pt-3 text-center shadow-soft text-white rounded mb-4">
                        <div class="px-3 px-lg-4 py-5 text-center">
                            <h3 class=" fw-bold mb-4 text-light">
            ...
            <?php $__currentLoopData = $quizuser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(auth()->id()==$user->user_id): ?>
            <div class="justify-content-center mb-5 mb-lg-6 <?php echo e(auth()->id() == $user->user_id ?'d-none' : ''); ?>">
            <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Belajar Web\KPP\resources\views/index.blade.php ENDPATH**/ ?>