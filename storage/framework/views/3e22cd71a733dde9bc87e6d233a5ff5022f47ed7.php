                                ...
                                <tr>
                                    ...
                                    <td>
                                      <div class="d-flex ">
                                        ...
                                        <div class="my-auto">
                                          <h6 class="mb-0 text-xs"><?php echo e($item->ip_cctv); ?></h6>
                                        </div>
                                      </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                      <p class="text-xs font-weight-bold mb-0"><?php echo e($item->username); ?></p>
                                    </td>
                                    <td>
                                      <p class="text-xs font-weight-bold mb-0"><?php echo e($item->password); ?></p>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align-middle text-center  justify-content-center d-flex">
                                        ...
                                        <div class="modal fade" id="exampleModal1<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <?php echo $__env->make('admin.kategori_barang.CCTV.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <div class="modal fade" id="exampleModal2<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <?php echo $__env->make('admin.kategori_barang.CCTV.hapus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                      </span>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Belajar Web\KPP\resources\views/admin/kategori_barang/CCTV/cctv.blade.php ENDPATH**/ ?>