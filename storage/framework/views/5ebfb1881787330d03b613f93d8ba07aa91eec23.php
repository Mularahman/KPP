                ...
                <div class="card col-lg-6 shadow">
                    <div class="card-body">
                        ...
                        <table class="table  table-centered table-nowrap mb-0 rounded">
                            ...
                            <tr  >
                                <td colspan="2" class="text-center"><h4 class="text-success"> <?php echo e($hasilakhir); ?></h4></td>
                            </tr>
                        </table>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tes Psikotes\resources\views/tes/hasil.blade.php ENDPATH**/ ?>