                        ...
                        <div class="card border-0 shadow ">
                            <div class="card-body">
                                ...
                                <table class="table  table-centered table-nowrap mb-0 rounded">
                                    ...
                                    <tr  >
                                        <td colspan="2" class="text-center"><h4  class="text-success"> <?php echo e($nilai); ?></h4></td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tes Psikotes\resources\views/nilai.blade.php ENDPATH**/ ?>