...
<?php $__env->startSection('breadcumb'); ?>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data UMPC</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Data UMPC</h6>
    </nav>
<?php $__env->stopSection(); ?>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Serial Number
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <div class="d-flex ">
                                        ...
                                        <div class="my-auto">
                                          <h6 class="mb-0 text-xs"><?php echo e($item->sn_umpc); ?></h6>
                                        </div>
                                      </div>
                                    </td>
                                    <td>
                                      <p class="text-xs font-weight-bold mb-0"><?php echo e($item->unit); ?></p>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align-middle text-center  justify-content-center d-flex">
                                        ...
                                        <div class="modal fade" id="exampleModal1<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <?php echo $__env->make('admin.kategori_barang.UMPC.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <div class="modal fade" id="exampleModal2<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <?php echo $__env->make('admin.kategori_barang.UMPC.hapus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                      </span>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Belajar Web\KPP\resources\views/admin/kategori_barang/UMPC/umpc.blade.php ENDPATH**/ ?>