              ...
              <div class="row">
                    ...
                    <div class="card-body">
                        <?php if(session()->has('error')): ?>
                                        <div class="alert alert-danger alert-dismissible fade show">
                                            <span class="alert-text"><strong><?php echo e(session('error')); ?></strong></span>
                                    ...
                                    <form action="/loginuser" method="POST" class="mt-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex justify-content-between align-items-top mb-3">
                                                ...
                                                <div><a href="<?php echo e(route('forget.password.get')); ?>" class="small text-right">Lost password?</a></div>
                                            </div>
                                        </div>
                ...
                <div class="col-md-6">
                  <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                    <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('/backend/assets/img/curved-images/curved6.jpg')"></div>
                  </div>
                </div>
              </div>
            </div>
...
<?php /**PATH D:\Belajar Web\KPP\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>