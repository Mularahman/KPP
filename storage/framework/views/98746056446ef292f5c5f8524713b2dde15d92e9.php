                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center  justify-content-center d-flex">
                                        ...
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn bg-gradient-danger me-md-1" data-bs-toggle="modal" data-bs-target="#exampleModal2<?php echo e($item->id); ?>">
                                        ...
                                        <div class="modal fade" id="exampleModal2<?php echo e($item->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <?php echo $__env->make('admin.datapeserta.hapus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Belajar Web\KPP\resources\views/admin/datapeserta/peserta.blade.php ENDPATH**/ ?>