...
<?php $__env->startSection('breadcumb'); ?>
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Laporan Hasil Tes <?php echo e($quiz->quiz); ?></h6>
    </nav>
<?php $__env->stopSection(); ?>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col">
                            <a class="btn bg-gradient-primary d-inline-flex me-md-2 " href="/hasilquiz/<?php echo e($id); ?>/cetak">
                        ...
                        <div class="col">
                            <form action="/hasilquiz/<?php echo e($id); ?>" method="get">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tes Psikotes\resources\views/admin/hasilquiz/hasil.blade.php ENDPATH**/ ?>