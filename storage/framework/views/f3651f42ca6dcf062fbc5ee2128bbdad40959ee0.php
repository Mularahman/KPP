...
<section class="section ">
    ...
    ?>
        <h2 id="demo" class="time text-center mb-4" ><?php echo e($data->quiz->time); ?></h2>
    <div class="container ">
                    ...
                    <div class="card border-0 shadow bg-gray-800 px-5 py-2 ">
                        <div class="text-center mt-3 mb-3">
                            <div class="text-white">
                                <h5>Tes <?php echo e($data->quiz->jenisquiz); ?></h5>
                            <h3 class="mb-5"><?php echo e($data->quiz->quiz); ?></h3>
                            ...
                            <div class="card justify-content-center mt-4 mb-4">
                                    <h5 class="mt-3"><?php echo e($data->soal); ?></h5>
                                            ...
                                            <tr>
                                                <th class="text-gray-900" scope="row">
                                                        <div class="col-2 col-lg-1">
                                                            <button onclick="send(this)" id="pilihan_a" class="<?php echo e($data->jawab == 'A' ?'btn-primary' : 'btn-outline-primary'); ?> btn d-inline-flex align-items-center me-md-3 "
                                                            type="submit"
                                                            >A</button> <?php echo e($data->a); ?>
  ...
  <div class="modal-dialog  modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
       ...
       <h4 class="time"><?php echo e($data->quiz->time); ?></h4>
      </div>
...
<?php /**PATH D:\Tes Psikotes\resources\views\quiz\quiznilaisama.blade.php ENDPATH**/ ?>